...
if [ "$DO_TEST" -eq 1 ]; then
  ...
  zmap --probe-module="$MODULE_NAME" -o "data/icmp_timestamp.csv" -I "$TEST_TARGET" --output-module=csv --output-fields="*"
else
  zmap --probe-module="$MODULE_NAME" -o "data/icmp_timestamp.csv" 0.0.0.0/0 --output-module=csv --output-fields="*"
fi
